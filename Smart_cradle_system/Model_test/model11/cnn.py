...
with open('D:\\HK2-Năm 3\\PBL5\\Code\\Smart_cradle_system\\Model_test\\model11\\cnn.json', 'r') as f:
    mymodel=model_from_json(f.read())

mymodel.load_weights("D:\\HK2-Năm 3\\PBL5\\Code\\Smart_cradle_system\\Model_test\\model11\\cnn.h5")
